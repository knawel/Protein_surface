...
# standard elements (sorted by abundance) (6)
std_elements = np.array([
    'C', 'O', 'N', 'S', 'P', 'H'
])

# standard residue names: AA/RNA/DNA (sorted by abundance) (28)
...
# standard atom names contained in standard residues (sorted by abundance) (69)
std_names = np.array([
